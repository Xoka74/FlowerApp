...
import com.shurdev.myPlants.screens.details.MyPlantDetailsRoute
import com.shurdev.myPlants.screens.myPlants.MyPlantsRoute
...
fun NavController.navigateToMyPlantDetailsScreen(plantId: PlantId) = navigate(MyPlantDetails(plantId))
